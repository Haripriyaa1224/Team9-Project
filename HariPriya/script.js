...
const optionList = ["Two-Column", "Minimalist", "pro"];
const color1 = ["#0C5334", "#D3D3D3", "#fbb03b"];
const color2 = ["#ffffff", "#000000", "#000000"];
// header and header text color
document.querySelector("#color1").value = "#0C5334";
...
//add skill to template1
function addSkill(temp1_skill_div, temp1_skill_arr) {
  temp1_skill_arr.forEach((skill) => {
    
    let span = document.createElement('span');
    span.textContent = skill;
    span.style.color = 'white';
    span.style.backgroundColor = 'black';
    span.style.display = 'inline-block'; // Ensures each span appears on a new line
    span.style.padding = '5px'; // Optional: Add padding for better appearance
    span.style.margin = '5px'; // Optional: Add margin to separate skills
    span.style.fontSize = '12px';
    temp1_skill_div.appendChild(span);
  });
}
...
addEmploymentBtn.addEventListener("click", (e) => {
  ...
  addEmploymentInfo.innerHTML = `
    ...
    <button id="add_emplyoment_data">Add</button>
    `;
...
addProjectBtn.addEventListener("click", (e) => {
  ...
  addProjectInfo.innerHTML = `
    ...
    <p id="warning"></p>
    <button id="add_project_data">Add</button>
    `;
...
addEducationBtn.addEventListener("click", (e) => {
  ...
  addEducationInfo.innerHTML = `
    ...
    <button id="add_education_data">Add</button>
    `;
